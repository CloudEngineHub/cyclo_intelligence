...
// Author: Seongwoo Kim
//
// WARM-MINIMAL REDESIGN: Action nodes = sage; running = clay + pulse;
// selected = sage with an ink ring. Drop-in replacement for
// orchestrator/ui/src/components/bt/BTActionNode.js
