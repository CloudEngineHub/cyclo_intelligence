...
export default function PolicyBackendControl({ serviceType }) {
  ...
  return (
    <div className="mb-3 border-t border-b border-gray-200 py-2">
      ...
      <div className={clsx('grid gap-2', showPullButton ? 'grid-cols-2' : 'grid-cols-3')}>
        {showPullButton && (
          <button
            type="button"
      ...
      {isRunning && (
        <>
          <div className="mt-2 grid grid-cols-2 gap-2">
            {processDefinitions.map(({ name, label: processLabel }) => {
